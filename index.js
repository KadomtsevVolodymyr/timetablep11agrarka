...
bot.on('message', (msg) => {
  ...
  bot.sendPhoto(chatId, 'photo.jpg', {
	...
	bot.editMessageReplyMarkup({ reply_markup: JSON.stringify({ keyboard: [] })})
});
...
if (query.data === 'time') {
	bot.sendPhoto(chatId, 'time.jpg',
		{reply_markup: {inline_keyboard: keyboardMenu}});//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!1
}
...
if (query.data === 'monday') {
	...
	if (query.data === 'wednesday') {
		bot.sendPhoto(chatId, 'wensday.jpg',//Замена на фото
		{reply_markup: {inline_keyboard: keyboard}});
}
	...
	if (query.data === 'saturday') {
		bot.sendPhoto(chatId, 'saturday.jpg',//Замена на фото
			{reply_markup: {inline_keyboard: keyboard}});
	}
});
